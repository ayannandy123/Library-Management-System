...
public class Return_Book extends JFrame implements ActionListener {
  ...
  /*  public void delete() {
	...
	JLabel lblStudentid = new JLabel("Book_id");
	...
	textField.setBounds(135, 56, 105, 20);
    ...
    public void actionPerformed(ActionEvent ae){
		...
		ResultSet rs = st.executeQuery();
                ...
                if(rs.next()) {
                    ...
                    textField_5.setText(rs.getString("dept"));
		...
		rs.close();
            ...
            if(ae.getSource() == b2){
                ...
                String sql = "update issuebook set returndate=? where student_id=? and book_id=?";
		PreparedStatement st = con.c.prepareStatement(sql);
		...
		if (i > 0) {
                    ...
                    String sql1="update book set occupied=? where book_id=?";
                    PreparedStatement st1=con.c.prepareStatement(sql1);
                    st1.setString(1,"N");
                    st1.setString(2,textField_1.getText());
                    st1.executeUpdate();
                    String sql2="update student set count=count-1 where std_id=?";
